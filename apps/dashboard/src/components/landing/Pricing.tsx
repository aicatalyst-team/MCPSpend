    ...
    <section id="pricing" className="py-24 border-t border-white/5">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mt-10 flex items-center justify-center gap-3">
          ...
          >
            Yearly
            <span className="text-[10px] uppercase tracking-widest font-bold text-brand-400 bg-brand-500/10 border border-brand-500/30 rounded px-1.5 py-0.5">
              2 months free
            </span>
          </button>
        </div>
              ...
              >
                ...
                {!isFree && cadence === 'yearly' && (
                  <div className="mt-1 text-xs text-gray-500">
                    ≈ ${Math.round((t.yearly || 0) / 12)}/mo · billed yearly
                  </div>
                )}
        ...
        <p className="mt-8 text-xs text-gray-500 text-center">
          ...
          Billed by NewRzs SRL (CUI RO48756557) · processed securely by Stripe. Cancel anytime, keep your data.
        </p>
      </div>
    </section>
  )
